...
public class CustomListener extends TestUtil implements ITestListener,ISuiteListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		try{
			...
			testReport.get().addScreenCaptureFromPath(TestUtil.failScreenShot(methodName));
